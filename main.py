...
def get_products(page, cookies, headers):
    response = requests.get(f'https://www.auchan.ru/catalog/bakaleya/sol-specii-i-pripravy/?page={page}', cookies=cookies, headers=headers)
...
def get_info():
    ...
    for reg in range(1,3):
        ...
        response = s.get('https://www.auchan.ru/catalog/bakaleya/sol-specii-i-pripravy/', cookies=cookies, headers=headers)
        ...
        for page in range(1, pages+1):
            get_products(page, cookies, headers)
